const covid19ImpactEstimator = (data) => {
  ...
  impact.dollarsInFlight = Math.trunc((impactReq * populationOfIncome * avgY) / days);
  severeImpact.dollarsInFlight = Math.trunc((severeReq * populationOfIncome * avgY) / days);
  // return
  return {
    data,
    impact,
